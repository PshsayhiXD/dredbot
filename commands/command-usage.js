...
export const commandEmbed = async ({ title = 'null', description = 'null', color = '#2f3136', footer = null, thumbnail = config.BotAvatarURL, image = null, fields = [], user = null, message = null, reward = true } = {}) => {
  try {
